...
Get-ChildItem -Path $TopDir | Measure-Object -property length -sum

Get-ChildItem -Path $TopDir |
    Where-Object PSIsContainer -eq $false |
    Sort-Object -Property LastWriteTime |
    Select-Object  Name, Length, LastWriteTime | Export-Csv backup-list.csv -Encoding UTF8
...
$files = Get-ChildItem -Path $TopDir | 
    Where-Object PSIsContainer -eq $false |
    Sort-Object -Property LastWriteTime
...
$lastWriteTime = (Get-Item -Path "$TopDir\IMG_20181113_145307.jpg").LastWriteTime
$nexts = Get-ChildItem -Path $TopDir | Where-Object LastWriteTime -gt $lastWriteTime
